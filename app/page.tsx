...
export default function Home() {
  ...
  return <main>
    <header className="nav"><a className="brand" href="#top"><span>DEMM</span><small>PHOTO BOOTHS • ATLANTA</small></a><nav aria-label="Main navigation"><a href="/weddings">Weddings</a><a href="/event-planners">Event Planners</a><a href="/birthdays">Parties</a><a href="https://www.welcome2atlantaevents.com/find" target="_blank" rel="noopener noreferrer">Find My Photos</a><a href="#gallery">Gallery</a><a href="#faq">FAQ</a></nav><a className="button small" href="#quote">Check My Date</a></header>
    ...
    <footer><div className="brand"><span>DEMM</span><small>PHOTO BOOTHS • ATLANTA</small></div><p>More than pictures. We bring the energy, engagement, and professional experience that makes guests participate.</p><div><a href="/weddings">Weddings</a><a href="/event-planners">Event Planners</a><a href="/birthdays">Birthday Parties</a><a href="#faq">FAQ</a></div><small>© 2026 DEMM Photo Booths Atlanta. All rights reserved. • Privacy • Terms</small></footer>
