...
const faqs = [
  ["What is included with the DEMM Photo Booth Experience?", "Every event is customized. Your experience includes professional photo capture, flattering lighting, a custom photo design, instant digital sharing, and a professional attendant who stays with the booth for your entire event — from setup before your guests arrive through breakdown after the last photo is taken. Prints, backdrops, props, and premium enhancements are available based on your event."],
  ...
  ["Is someone with the booth the whole time or just for setup?", "DEMM stays with the booth for your entire event — this is not a drop-off service. We arrive early to set up before your guests, operate the booth and keep energy moving for the full duration, and handle complete breakdown at the end. You never have to manage or monitor the equipment."],
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="orb one"/><div className="orb two"/><div className="hero-inner"><p className="eyebrow">ATLANTA <i/> METRO ATLANTA</p><h1>Atlanta Events Deserve More Than an <em>Ordinary</em> Photo Booth.</h1><p className="lead">Professional photos, custom event design, instant sharing, and the energy that gets your guests involved—all handled from setup to breakdown.</p><div className="actions"><a className="button" href="#quote">Check My Date &amp; Get a Custom Quote</a><a className="button secondary" href="https://www.welcome2atlantaevents.com/find" target="_blank" rel="noopener noreferrer" style={{ background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.25)", color: "#fff", marginLeft: "12px" }}>Find My Photos ↗</a></div><div className="trust"><span>Attendant Stays Your Full Event</span><span>Custom Event Design</span><span>Instant Sharing</span><span>Optional Lead Capture</span><span>Setup &amp; Breakdown Included</span></div></div><div className="hero-card" aria-hidden="true"><div className="flash">✦</div><div className="photo" style={{ backgroundImage: "url('/images/hero-energy.png')", backgroundSize: "cover", backgroundPosition: "center" }} /><p>YOUR MOMENT.<br/><b>BEAUTIFULLY CAPTURED.</b></p></div></div></section>

    <GoogleReviewsTicker />

    <section className="proof"><span>Elevated Guest Experiences</span><span>Professionally Hosted</span><span>135 Google Reviews · 5.0 ★</span><span>Serving Metro Atlanta</span></section>

    <section className="section split" id="experience"><div><p className="eyebrow">THE DEMM EXPERIENCE</p><h2>We Don't Just Set Up a Booth. <em>We Bring the Energy.</em></h2></div><div><p className="large">Your event deserves more than equipment placed in a corner. DEMM creates an interactive photo experience that invites guests in, keeps the energy moving, and gives everyone something worth sharing and remembering.</p><ul className="checks"><li>Professional attendant present for your entire event — not just setup</li><li>High-quality photo capture and flattering lighting</li><li>Custom event-branded photo design</li><li>Instant digital sharing via text or email</li><li>Setup before guests arrive &amp; full breakdown at the end</li><li>Optional prints, backdrops, props, and premium enhancements</li><li>Optional guest-registration for qualifying business events</li></ul></div></section>
