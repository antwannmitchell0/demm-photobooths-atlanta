...
export default function Home() {
  ...
  return <main>
    ...
    <footer><div className="brand"><span>DEMM</span><small>PHOTO BOOTHS • ATLANTA</small></div><p>More than pictures. We bring the energy, engagement, and professional experience that makes guests participate.</p><div style={{display:"flex",gap:"32px",flexWrap:"wrap",marginBottom:"12px"}}><div style={{display:"flex",flexDirection:"column",gap:"8px"}}><strong style={{fontSize:"11px",letterSpacing:"0.1em",opacity:0.5,textTransform:"uppercase"}}>Events</strong><a href="/weddings">Weddings</a><a href="/quinceaneras">Quinceañeras</a><a href="/event-planners">Corporate &amp; Planners</a><a href="/birthdays">Birthday Parties</a></div><div style={{display:"flex",flexDirection:"column",gap:"8px"}}><strong style={{fontSize:"11px",letterSpacing:"0.1em",opacity:0.5,textTransform:"uppercase"}}>Cities We Serve</strong><a href="/alpharetta">Alpharetta</a><a href="/marietta">Marietta</a><a href="/sandy-springs">Sandy Springs</a><a href="/duluth">Duluth</a><a href="/norcross">Norcross</a></div><div style={{display:"flex",flexDirection:"column",gap:"8px"}}><strong style={{fontSize:"11px",letterSpacing:"0.1em",opacity:0.5,textTransform:"uppercase"}}>Quick Links</strong><a href="#faq">FAQ</a><a href="https://www.welcome2atlantaevents.com/find" target="_blank" rel="noopener noreferrer">Find My Photos</a><a href="#quote">Book Now</a></div></div><small>© 2026 DEMM Photo Booths Atlanta. All rights reserved. Serving Fulton, Cobb, Gwinnett, DeKalb &amp; Cherokee Counties.</small></footer>
